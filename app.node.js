...
/***/ function(module, exports, __webpack_require__) {
  ...
  var Packery = __webpack_require__(25)(React);
  ...
  var Images = React.createClass({
    ...
    render: function render() {
      var childElements = this.props.list.map(function (element) {
        return React.createElement('img', { src: element });
      });
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsImages = __webpack_require__(5);

  var _componentsImages2 = _interopRequireDefault(_componentsImages);

  var _componentsSpinner = __webpack_require__(9);
  ...
  var _default = (function (_Component) {
    ...
    _createClass(_default, [{
      ...
      value: function componentDidMount() {
        var keyword = this.isBirthday() ? 'birthday' : this.isAnniversary() ? 'anniversary' : 'happy';
        var url = this.endpoint + '/data/' + keyword + '.json';
      ...
      value: function render() {
        ...
        var images = Object.keys(this.state.data).map(function (item) {
          return _this2.state.data[item].rgi_image;
        });
        ...
        ) : this.isAnniversary() ? _react2['default'].createElement(
          'h2',
          null,
...
/***/ function(module, exports) {
  ...
  module.exports = require("react-packery-component");
